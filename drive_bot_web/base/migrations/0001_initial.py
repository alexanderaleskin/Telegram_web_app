    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_format', models.CharField(blank=True, choices=[('T', 'Text'), ('P', 'Image'), ('D', 'Document'), ('A', 'Audio'), ('V', 'Video'), ('G', 'GIF/animation'), ('TV', 'Voice'), ('VN', 'Video note'), ('S', 'Sticker'), ('L', 'Location'), ('GM', 'Media Group')], max_length=2, null=True)),
                ('media_id', models.CharField(max_length=512)),
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.fileitem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_link', models.CharField(choices=[('S', 'Only show'), ('C', 'Show and change')], max_length=1)),
                ('share_amount', models.IntegerField()),
                ('share_code', models.CharField(max_length=64, unique=True)),
                ('file_folder_item', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sharelinks', to='base.fileitem')),
            ],
            options={
                'ordering': ['type_link'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mount_folder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.fileitem')),
