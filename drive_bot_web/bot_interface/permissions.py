...
from base.models import ShareLink, FileItem
...
class CheckFolderPermission(BasePermissionClass):
    def help_check_func(self, CheckClass, field_name, user, utrl_args):
        ...
        if method != 'cr':
            ...
            instance = FileItem.objects.get(id=instance_id)
    ...
    def has_permissions(self, bot, update, user, utrl_args, **kwargs):
        need_extra_check, check_types, folder = self.help_check_func(FileItem, 'parent', user, utrl_args)
